...
- **작습니다** — `src/` 의 C99 코드가 2,312 줄이고 그중 1,498 줄이 디코딩 경로입니다(1.4KB 학습 확률표 포함). libc 말고는 의존하는 것이 없습니다.
...
| 단순성 | **예산 안, 다만 누구와도 겨룬 적 없음** | 디코딩 경로 1,498 줄, 전체 2,312 줄, 외부 의존 0, 규격 12 쪽 이내. 이 축에서 상대를 재본 적이 없습니다 |

...
**여러 축에서 동시에 이기는 것**을 목표로 만든 손실 이미지 코덱입니다. 압축률 하나만 보지 않습니다. 이것이 **v1.2** 입니다.

[English](README.md)

대부분의 코덱은 한 성질을 얻으려고 다른 성질을 내줍니다. ingot 은 아무도 최적화하지 않아 비어 있던 축을 골라, 그것을 포맷 자체에 못박았습니다.

- **JPEG 과 WebP 를 세 지표 모두에서 앞섭니다** — 표준 사진에서 JPEG 대비 **−27.5%**(PSNR), **−25.4%**(SSIM), **−16.7%**(SSIMULACRA2), WebP 대비 **−10.7%**, **−1.5%**, **−5.8%** 입니다. JPEG XL 은 PSNR 로 **−5.5%** 앞섭니다. AVIF 는 아직 우리보다 앞서 있습니다.
...
- **작습니다** — `src/` 의 C99 코드가 2,134 줄이고 그중 1,363 줄이 디코딩 경로입니다. libc 말고는 의존하는 것이 없습니다.
...
| 단순성 | **예산 안, 다만 누구와도 겨룬 적 없음** | 디코딩 경로 1,363 줄, 전체 2,134 줄, 외부 의존 0, 규격 12 쪽 이내. 이 축에서 상대를 재본 적이 없습니다 |
